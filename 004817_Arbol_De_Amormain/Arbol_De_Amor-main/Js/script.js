...
fetch('Img/ArbolM.svg')
  ...
  .then(svgText => {
    ...
    const heartPaths = allPaths.filter(el => {
      ...
      return style.includes('#d92222ff') || style.includes('#080708ff');
    });
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Uriel";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-09-28T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-09-28T00:00:00');
